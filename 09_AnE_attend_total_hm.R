...
# Got to here data is clean, note to self find best way to label the y axis

#note to self dont forget to hash this again after getting hospital figures 
...
##############################
# code for the sum of total attendances of winters from 2017-25 dec,jan,feb,mar
...
write.csv(winter_summary, "winter_without_november.csv", row.names = FALSE)

print("Summary saved to winter_without_november.csv")

############
###### This is for code with November 
...
# Save the summary to a CSV file with the new name
write.csv(winter_summary, "winter_with_november_test.csv", row.names = FALSE)

print("Summary saved to winter_with_november_test.csv")

##############################

# This is the same code but have just added in totals for 16/17
